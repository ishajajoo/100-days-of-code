...
if dir.lower() == 'left':
  ...
  ''')
      ...
      dir_one = input("Type Swim/Wait:")
      if dir_one.lower()=='wait':
            print("Nice, you made it to the next level, you're pretty good at it\nWelcome to ")
            print ('''
     _                                     _     _                 _ 
    | |                                   (_)   | |               | |
    ...
    ''')
            ...
            dir_two = input("Dig/Cave?")
            if dir_two.lower=='dig':
